...
Customer Invoice Stage 2 pinning and execution wiring complete; authoritative Stage 1 billing instruction capture source remains required. The normal production Workbench/import flow does not currently author billing instructions. Missing Stage 1 evidence fails closed before accepted decision persistence, runtime creation, or ERP writer calls.
