...
- Draft Customer Invoice creation for `CUSTOMER_RECHARGE` allocations without `customer_invoice_id`, routed through `CustomerInvoiceExecutionStrategy`, `CustomerInvoiceWriter`, and `OdooCustomerInvoiceWriter` with duplicate-safe recovery.
